...
--Properties:
PrisonBreakerv13.Name = "هاك حرق و فشخ السيرفر"      --Change
PrisonBreakerv13.Parent = game.CoreGui

main.Name = "main"
main.Parent = PrisonBreakerv13
main.BackgroundColor3 = Color3.new(36, 36, 36)
...
title.Name = "title"
title.Parent = main
title.BackgroundColor3 = Color3.new(27, 42, 53)
title.Size = UDim2.new(0, 381, 0, 50)
title.Font = Enum.Font.ArialBold
title.Text = "هاك حرق و فشخ السيرفر"                 --change
...
credits.Text = "صانع الهاك zeiadamr"
...
inmate.Text = "فريق الحرامية"
inmate.TextColor3 = Color3.new(0, 0, 0)
inmate.TextSize = 14
inmate.MouseButton1Down:connect(function()
workspace.Remote.TeamEvent:FireServer("Really Red")    --change
end)
...
arrestcrims.Text = "القبض على المجرمين"
...
superpunch.Text = "الضربه الخارقه"
...
game.Players.LocalPlayer.Character.ClientInputHandler.Disabled = true
   ...
   message.Text = 'صانع الهاك zeiadamr'
   wait(2)
   message:Destroy()
end)
...
adminversion = "ادمن عربى, نسخه عربيه"
...
if game:GetService("Workspace").FilteringEnabled == true then
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "FE is Enabled";
        Text = "Filtering Enabled. تم تفعيل الادمن";
    })
else
    warn("FE is Disabled (Filtering Disabled) Consider using a different admin script.")
    game:GetService("StarterGui"):SetCore("SendNotification", {
...
aimbotandesp.Text = "فتح قائمه الايم بوت"
